export default function Home() {
  return <>
    <header className="header"><a href="#inicio" className="wordmark">CARMEN LLOSA</a><nav aria-label="Navegación principal"><a href="#sobre-mi">SOBRE MÍ</a><a href="#escritura">ESCRITURA</a><a href="#contacto" aria-label="SI TE APETECE, ESCRÍBEME :)">↗</a></nav></header>
    <main>
      ...
      <section className="section shell resume"><div className="resume-left"><h2 className="label">EN QUÉ ME FORMÉ</h2><ul className="education"><li>Curso de Periodismo en Moda, Belleza y Estilo de Vida<span>Vogue College of Fashion (Mayo- Julio 2026)</span></li><li>MBA en Dirección y Gestión de Empresas de Moda<span>Esden Business School (2015-2016)</span></li><li>Grado en Administración y Dirección de Empresas<span>Universidad de Oviedo (2010-2014)</span></li></ul>
        <img className="publications-photo" src="/images/pdf-publications.jpg" alt="Una mujer leyendo junto a su máquina de escribir" width="1035" height="642" loading="lazy"/></div><div className="resume-right"><img className="education-photo" src="/images/pdf-education.jpg" alt="Una mujer sosteniendo una pila de libros" width="827" height="785" loading="lazy"/><h2 className="label">DÓNDE ESCRIBO</h2><ul className="publications"><li><a href="https://lasoga.org/author/carmen/">La Soga Cultural (2025 - actualidad)</a></li><li>Newsletter Celia B (2024 - 2025)</li><li><a href="https://substack.com/@carmenllosa">Substack ( 2026 - actualidad)</a></li><li><a href="https://www.instagram.com/carmen.llosa/">Instragram (2021 - actualidad)</a></li></ul></div></section>
      ...
      <section className="section shell voice"><h2 className="label">QUÉ PUEDES ENCONTRAR EN MIS ARTÍCULOS:</h2><img className="voice-photo" src="/images/pdf-voice.jpg" alt="Una mujer rubia con gafas sentada en un café" width="910" height="1199" loading="lazy"/><ul><li>AUTOIRONÍA</li><li>COTIDIANIDAD</li><li>REFERENCIAS</li><li>HUMOR</li><li>REFLEXIÓN</li></ul></section>
      <section className="section shell inspiration"><h2 className="label">MI INSPIRACIÓN SERÍA ALGO ASÍ:</h2><img className="inspiration-collage" src="/images/pdf-inspiration.jpg" alt="Collage original del portfolio: cine, moda, arte, gastronomía y referencias personales" width="2584" height="1278" loading="lazy"/></section>
      <section id="escritura" className="section shell writing">
        <div className="work-heading"><h2 className="label">SUPONGO QUE DEBERÍA MOSTRARTE ALGUNOS EJEMPLOS, CLARO.</h2><img className="examples-photo" src="/images/pdf-examples.jpg" alt="Una mujer escribiendo frente a un ordenador" width="1009" height="877" loading="lazy"/><p>AHÍ, VAMOS:</p></div>
    ...
    <footer id="contacto" className="section shell"><h2><a href="mailto:carmenllosac@gmail.com">SI TE APETECE,<br/>ESCRÍBEME :)</a></h2><div className="contact"><a href="mailto:carmenllosac@gmail.com">CARMENLLOSAC@GMAIL.COM</a><a href="tel:+34654910959">654910959</a></div><img className="contact-photo" src="/images/pdf-contact.jpg" alt="Una mujer con un portátil" width="1498" height="842" loading="lazy"/></footer>
  </>;
}
