export default function Page() {
  return <>
<a className="skip-link" href="#contenido">Saltar al contenido</a><header className="header"><a href="/" className="wordmark">CARMEN LLOSA<span className="daisy-mark" aria-hidden="true">❀</span></a><nav aria-label="Navegación principal"><a href="/" aria-current="page">SOBRE MÍ</a><a href="/formacion/">TRAYECTORIA</a><a href="/mi-escritura/">ARTÍCULOS</a><a href="/contacto/">CONTACTO</a></nav></header><main id="contenido"><section id="sobre-mi" className="shell home-profile"><div className="profile-heading"><h1>¡Hola!<br/>Soy Carmen.</h1><p className="profile-intro">Me gusta que mi apellido<br/>rime con graciosa.</p></div><figure className="profile-photo"><img src="/images/pdf-cover.jpg" alt="Carmen sentada ante una estantería de revistas" width="923" height="1170" fetchPriority="high"/></figure><div className="bio profile-bio">
