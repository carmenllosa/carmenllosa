  ...
  return <>
    ...
    <main>
      ...
      <section className="section shell resume"><div className="resume-left"><h2 className="label">EN QUÉ ME FORMÉ</h2><ul className="education"><li>Curso de Periodismo en Moda, Belleza y Estilo de Vida<span>Vogue College of Fashion (Mayo- Julio 2026)</span></li><li>MBA en Dirección y Gestión de Empresas de Moda<span>Esden Business School (2015-2016)</span></li><li>Grado en Administración y Dirección de Empresas<span>Universidad de Oviedo (2010-2014)</span></li></ul></div>
        <div className="resume-right"><h2 className="label">DÓNDE ESCRIBO</h2><ul className="publications"><li><a href="https://lasoga.org/author/carmen/">La Soga Cultural (2025 - actualidad)</a></li><li>Newsletter Celia B (2024 - 2025)</li><li><a href="https://substack.com/@carmenllosa">Substack ( 2026 - actualidad)</a></li><li><a href="https://www.instagram.com/carmen.llosa/">Instragram (2021 - actualidad)</a></li></ul><img className="publications-photo" src="/images/pdf-publications.jpg" alt="Una mujer leyendo junto a su máquina de escribir" width="1035" height="642" loading="lazy"/></div></section>
