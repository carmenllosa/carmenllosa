...
const pages=[['','Sobre mí'],['mi-escritura','Mis textos'],['inspiracion','Inspiración'],['contacto','Contacto']];
for(const [slug,label] of pages){
 ...
 const head=`<meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${label} · Carmen Llosa</title><meta name="description" content="Carmen Llosa. Escritura creativa. ${label}.">`;
